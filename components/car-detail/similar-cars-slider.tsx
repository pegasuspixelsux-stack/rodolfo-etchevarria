...
export function SimilarCarsSlider({ cars }: { cars: Car[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4" style={{ scrollBehavior: "smooth", WebkitOverflowScrolling: "touch" }}>
        {cars.map((car) => (
